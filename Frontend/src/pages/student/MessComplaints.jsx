...
//         setUserComplaints(response.data.complaints || response.data || []);
//       } catch (err) {
...
//                   </svg>
//                 </div>
//                 <h3 className="text-xl font-semibold text-white mb-3">No Recent Complaints</h3>
//                 <p className="text-gray-400 max-w-xs mx-auto mb-6">
//                   You haven't submitted any complaints yet. Use the form to file a new complaint.
//                 </p>
//                 <div className="border-t border-[#2A2A4A] pt-6 mt-6">
//                   <p className="text-sm text-gray-500">
//                     All your submitted complaints will appear here for easy tracking
//                   </p>
//                 </div>
//               </div>
//             ) : (
//               <div className="space-y-4 max-h-[600px] overflow-y-auto pr-2 scrollbar-thin scrollbar-thumb-[#4A4A6A] scrollbar-track-[#0A0A1A] scrollbar-thumb-rounded-full scrollbar-track-rounded-full">
//                 {userComplaints.map((complaint) => (
//                   <div
//                     key={complaint._id}
//                     className="bg-[#0A0A1A] border border-[#2A2A4A] rounded-lg p-4 hover:shadow-md transition-shadow"
//                   >
...
//                     <p className="text-white mb-2 line-clamp-3">{complaint.description}</p>
...
//             <div className="max-w-4xl max-h-[90vh] overflow-hidden relative" onClick={(e) => e.stopPropagation()}>
//               <img
//                 src={selectedImage}
...
//                             onClick={() => openImageModal(URL.createObjectURL(image))}
//                           />
//                           <button
//                             type="button"
//                             onClick={() => removeImage(index)}
...
//                 type="submit"
//                 disabled={!category || !description || isSubmitting}
//                 className="w-full bg-gradient-to-r from-purple-700 to-purple-900 hover:from-purple-600 hover:to-purple-800 text-white py-3 rounded-md font-medium disabled:opacity-50 transition-all duration-300 transform hover:translate-y-[-2px] hover:shadow-lg"
//               >
//                 {isSubmitting ? (
...
//                         {complaint.category}
//                       </span>
//                       <span className={`text-sm font-medium px-3 py-1 rounded-full ${getStatusColor(complaint.status)}`}>
//                         {complaint.status || "Pending"}
//                       </span>
//                     </div>
...
//                     {complaint.images && complaint.images.length > 0 && (
//                       <div className="flex gap-2 overflow-x-auto py-2 custom-scrollbar-x">
//                         {complaint.images.map((image, index) => (
//                           <img
//                             key={index}
//                             src={image.url || image}
