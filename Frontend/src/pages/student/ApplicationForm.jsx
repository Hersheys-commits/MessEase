    ...
    <div className="bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen text-gray-100">
      ...
      <div className="max-w-3xl mx-auto p-6 py-8">
          ...
          <div>
            <h1 className="text-2xl font-bold text-white">
              ...
              <span className="text-indigo-300">
                {election.type === "messManager" ? "Mess Manager" : "Hostel Manager"}
              </span>
            </h1>
            <p className="text-gray-400 text-sm">Complete the application form below to submit your candidacy</p>
          </div>
        </div>
        ...
        <div className="bg-gray-800 p-8 rounded-b-lg shadow-xl border border-gray-700">
          ...
          <div className="mb-8 p-5 bg-indigo-900/20 rounded-lg border border-indigo-700/30 flex justify-between items-center">
            ...
            <div className="bg-green-500/20 px-3 py-1 rounded-full border border-green-500/30">
              <span className="text-green-400 text-sm font-medium">Applications Open</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="border-b border-gray-700 pb-2 mb-6">
              <h3 className="text-xl font-medium text-indigo-300">Application Questions</h3>
              <p className="text-gray-400 text-sm">Please answer all questions thoughtfully to strengthen your candidacy</p>
            </div>
  
            {election.applicationPhase.questions.map((question, index) => (
              <div key={index} className="mb-8 bg-gray-750 rounded-lg p-6 border border-gray-700 hover:border-indigo-500/50 transition-all duration-300">
        ...
        <div className="mt-6 bg-gray-800/50 rounded-lg p-4 border border-gray-700 flex items-center text-sm">
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-indigo-400 mr-2 flex-shrink-0" viewBox="0 0 20 20" fill="currentColor">
            <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-8-3a1 1 0 00-.867.5 1 1 0 11-1.731-1A3 3 0 0113 8a3.001 3.001 0 01-2 2.83V11a1 1 0 11-2 0v-1a1 1 0 011-1 1 1 0 100-2zm0 8a1 1 0 100-2 1 1 0 000 2z" clipRule="evenodd" />
          </svg>
          <span className="text-gray-400">
            Need help with your application? Contact the election committee at <span className="text-indigo-400">election-support@university.edu</span>
          </span>
        </div>
      </div>
    </div>
