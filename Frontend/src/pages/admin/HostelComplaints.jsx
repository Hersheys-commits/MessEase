...
// //             <h3 className="text-xl font-semibold text-gray-100 mb-2">No Complaints Found</h3>
            
// //             <p className="text-gray-300 text-center mb-4">
// //               There are currently no hostel complaints registered<span className="font-medium text-white"></span>.
// //             </p>
            
// //             <div className="bg-gray-900 p-4 rounded-lg border border-gray-700 w-full max-w-md">
// //               <h4 className="text-sm font-medium text-gray-200 mb-2">This could mean:</h4>
...
// //     }
// //   return (
// //     <div className="complaints-container bg-gray-900 text-gray-100 min-h-screen p-6">
// //     <h2 className="text-2xl font-bold mb-[-20px] text-blue-400">Complaints for Hostel: <span className="text-white"></span></h2>
// //     <Link to={`/admin/hostel/${code}`} className="z-1 pb-[-50%] flex pl-[90%] items-center space-x-2 text-blue-400 hover:text-blue-300 mb-6"> 
// //     Go Back</Link>
// //     <div className="complaints-list space-y-6">
// //         <h3 className="text-xl font-semibold mb-4 text-gray-300">
// //             Complaints Found <span className="text-blue-400">({complaints?.length})</span>
// //         </h3>
        
// //         {complaints?.map((complaint) => (
// //             <div key={complaint._id} className="complaint-card bg-gray-800 rounded-lg shadow-lg overflow-hidden border-l-4 border-blue-500 hover:border-blue-400 transition-all duration-200">
// //                 <div className="p-6">
...
// //                             complaint.status === 'In Progress' ? 'bg-yellow-900 text-yellow-300' : 
...
// //                         <strong className="text-gray-300">Date:</strong> {new Date(complaint.createdAt).toLocaleDateString()}
// //                     </p>
                    
// //                     <div className="mt-4">
// //                         <p className="text-gray-300 mb-2"><strong>Description:</strong></p>
// //                         <p className="text-gray-400 bg-gray-700 p-3 rounded-md">{complaint.description}</p>
// //                     </div>

// //                     {/* Image Gallery Section */}
// //                     {complaint.images && complaint.images.length > 0 && (
// //                         <div className="mt-4">
// //                             <p className="text-gray-300 mb-2"><strong>Attached Images:</strong></p>
...
// //                             <h5 className="text-sm font-semibold text-blue-400 mb-2">ADMIN RESPONSE:</h5>
...
//         try {
//             setUpdatingId(id);
//             const response = await api.post(`/api/complaint/updatecomplaint/${id}/${status}`);
...
//                     Complaints for Hostel: <span className="text-white">{code}</span>
//                 </h2>
//                 <Link 
...
//                                 <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
//                                     complaint.status === 'Resolved' ? 'bg-green-900 text-green-300' : 
//                                     complaint.status === 'Closed' ? 'bg-purple-900 text-purple-300' : 
//                                     'bg-red-900 text-red-300'
//                                 }`}>
//                                     {complaint.status || 'Pending'}
//                                 </span>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-2">
                        <span className="flex items-center text-xs text-gray-400">
                            <span className="w-2 h-2 rounded-full bg-red-500 mr-1"></span> Pending
                        </span>
                        <span className="flex items-center text-xs text-gray-400">
                            <span className="w-2 h-2 rounded-full bg-green-500 mr-1"></span> Resolved
                        </span>
                        <span className="flex items-center text-xs text-gray-400">
                            <span className="w-2 h-2 rounded-full bg-purple-500 mr-1"></span> Closed
                        </span>
                    </div>
                </div>
